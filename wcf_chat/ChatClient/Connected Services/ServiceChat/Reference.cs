...
namespace ChatClient.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendMsg")]
        System.Threading.Tasks.Task SendMsgAsync(string msg, int sender, string recipient);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IServiceChat/GetUsersNames", ReplyAction = "http://tempuri.org/IServiceChat/GetUsersNamesResponse")]

        System.Collections.Generic.List<string> GetUsersNames();

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IServiceChat/GetNameById", ReplyAction = "http://tempuri.org/IServiceChat/GetNameByIdResponse")]
        string GetNameById(int id);
        [System.ServiceModel.OperationContractAttribute(IsOneWay = true, Action = "http://tempuri.org/IServiceChat/InstallChats")]
        void InstallChats();
        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IServiceChat/GetIdByName", ReplyAction = "http://tempuri.org/IServiceChat/GetIdByNameResponse")]
        int GetIdByName(string userName);
        [System.ServiceModel.OperationContractAttribute(IsOneWay = true, Action = "http://tempuri.org/IServiceChat/SetDialog")]
    ...
    public interface IServiceChatCallback {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay = true, Action = "http://tempuri.org/IServiceChat/GetChats")]
        void GetChats(string userName);
        [System.ServiceModel.OperationContractAttribute(IsOneWay = true, Action = "http://tempuri.org/IServiceChat/SetNewDialog")]
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<ChatClient.ServiceChat.IServiceChat>, ChatClient.ServiceChat.IServiceChat {
        ...
        public void SendMsg(string msg, int sender, string recipient) {
            base.Channel.SendMsg(msg, sender, recipient);
        }
        public System.Collections.Generic.List<string> GetUsersNames()
        {
        ...
        {
             base.Channel.InstallChats();
        }
        public int GetIdByName(string userName)
        {
            return base.Channel.GetIdByName(userName);
        }
        public void SetDialog(int ID, string withUser)
        {
            base.Channel.SetDialog(ID, withUser);
        }
        public System.Threading.Tasks.Task SendMsgAsync(string msg, int sender, string recipient) {
            return base.Channel.SendMsgAsync(msg, sender, recipient);
        }
